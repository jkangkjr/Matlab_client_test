...
#include "test1_msgs/msg/detail/test__rosidl_typesupport_fastrtps_c.h"
...
using _Test__ros_msg_type = test1_msgs__msg__Test;
...
static uint32_t _Test__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_test1_msgs__msg__Test(
...
{
  return max_serialized_size_test1_msgs__msg__Test(
    full_bounded, 0);
}
